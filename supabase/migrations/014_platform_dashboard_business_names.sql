-- Surface the workspace business name in the platform dashboard. The source is
-- workspace settings (`workspace_app_state.key = 'settings'`) so the platform
-- usage card reflects the customer's configured business identity.
